...
model_ca = NaiveBayesClassifier(1, 3, 0.5, "./training_files/ca_training-tweets.txt", "ca", 18318)
model_gl = NaiveBayesClassifier(1, 3, 0.5, "./training_files/gl_training-tweets.txt", "gl", 18318)
model_en = NaiveBayesClassifier(1, 3, 0.5, "./training_files/en_training-tweets.txt", "en", 18318)
model_es = NaiveBayesClassifier(1, 3, 0.5, "./training_files/es_training-tweets.txt", "es", 18318)
model_pt = NaiveBayesClassifier(1, 3, 0.5, "./training_files/pt_training-tweets.txt", "pt", 18318)
model_eu = NaiveBayesClassifier(1, 3, 0.5, "./training_files/eu_training-tweets.txt", "eu", 18318)
